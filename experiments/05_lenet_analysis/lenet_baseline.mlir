...
module {
  func.func @main(%arg0: tensor<1x3x32x32xf32>) -> tensor<1x10xf32> {
    ...
    } {neura.fan_avg = 0.19999999996000001 : f64, neura.i_arith = 0.000000e+00 : f64, neura.l_depth = 1 : i32, neura.op_count = 5 : i64, neura.placement_x = 0 : i32, neura.placement_y = 1 : i32, neura.r_affine = 0.99999999949999996 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 645120 : i64, neura.streaming_succs = [13 : i32], neura.task_id = 11 : i32, neura.v_live_out = 32 : i64}
    ...
    } {neura.fan_avg = 0.45454545450413225 : f64, neura.i_arith = 0.49999999987499999 : f64, neura.l_depth = 2 : i32, neura.op_count = 11 : i64, neura.placement_x = 0 : i32, neura.placement_y = 0 : i32, neura.r_affine = 0.99999999974999997 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 329088 : i64, neura.streaming_succs = [14 : i32], neura.task_id = 13 : i32, neura.v_live_out = 32 : i64}
    ...
    } {neura.fan_avg = 0.42857142851020408 : f64, neura.i_arith = 0.33333333322222219 : f64, neura.l_depth = 1 : i32, neura.op_count = 7 : i64, neura.placement_x = 0 : i32, neura.placement_y = 0 : i32, neura.r_affine = 0.99999999966666663 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 8064 : i64, neura.streaming_succs = [15 : i32], neura.task_id = 14 : i32, neura.v_live_out = 32 : i64}
    ...
    } {neura.fan_avg = 0.57142857134693881 : f64, neura.i_arith = 0.99999999949999996 : f64, neura.l_depth = 1 : i32, neura.op_count = 7 : i64, neura.placement_x = 0 : i32, neura.placement_y = 0 : i32, neura.r_affine = 0.99999999949999996 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 5376 : i64, neura.streaming_succs = [18 : i32], neura.task_id = 15 : i32, neura.v_live_out = 32 : i64}
    ...
    } {neura.fan_avg = 0.19999999996000001 : f64, neura.i_arith = 0.000000e+00 : f64, neura.l_depth = 1 : i32, neura.op_count = 5 : i64, neura.placement_x = 0 : i32, neura.placement_y = 2 : i32, neura.r_affine = 0.99999999949999996 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 53760 : i64, neura.streaming_succs = [18 : i32], neura.task_id = 16 : i32, neura.v_live_out = 32 : i64}
    %alloc_24 = memref.alloc() {alignment = 64 : i64} : memref<1x10xf32>
    affine.for %arg1 = 0 to 1 {
      affine.for %arg2 = 0 to 10 {
        affine.store %cst_6, %alloc_24[%arg1, %arg2] : memref<1x10xf32>
      }
    } {neura.fan_avg = 0.000000e+00 : f64, neura.i_arith = 0.000000e+00 : f64, neura.l_depth = 1 : i32, neura.op_count = 4 : i64, neura.placement_x = 3 : i32, neura.placement_y = 1 : i32, neura.r_affine = 0.99999999899999991 : f64, neura.r_vec = 0.000000e+00 : f64, neura.rec_mii = 1.000000e+00 : f64, neura.s_buffer = 320 : i64, neura.task_id = 17 : i32, neura.v_live_out = 32 : i64}
